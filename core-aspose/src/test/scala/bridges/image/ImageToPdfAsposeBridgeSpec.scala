...
import types.MimeType.{ImageJpeg, ImagePng, ApplicationPdf}
...
class ImageToPdfAsposeBridgeSpec extends BridgeSpec with BeforeAndAfterAll {
  ...
  "JpegToPdfAsposeBridge" should "convert JPEG to PDF" in {
    ...
    val jpegHeader = Array[Byte](
      ...
      0x00.toByte, 0x10.toByte, // APP0 length (16 bytes)
      ...
      0x00.toByte, 0x00.toByte  // Thumbnail size (0x0)
    )
  ...
  "PngToPdfAsposeBridge" should "convert PNG to PDF" in {
    ...
    val pngHeader = Array[Byte](
      ...
      0x0D.toByte, 0x0A.toByte, 0x1A.toByte, 0x0A.toByte, // PNG signature continued
      ...
      0x00.toByte, 0x00.toByte, 0x00.toByte, 0x01.toByte, // width (1 pixel)
      0x00.toByte, 0x00.toByte, 0x00.toByte, 0x01.toByte, // height (1 pixel)
