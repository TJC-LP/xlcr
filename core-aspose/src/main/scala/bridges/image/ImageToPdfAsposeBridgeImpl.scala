...
import com.aspose.pdf.{Document, Image => PdfImage, MarginInfo, Page, PageSize}
import org.slf4j.LoggerFactory

import java.io.{ByteArrayInputStream, ByteArrayOutputStream}

/** Common implementation for Image to PDF conversion using Aspose.PDF.
  * This trait provides the core functionality for converting images to PDF,
  * with automatic page size adjustment for landscape images.
  */
