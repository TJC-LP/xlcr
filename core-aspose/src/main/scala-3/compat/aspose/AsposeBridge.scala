...
/**
 * Helper class for working with Aspose libraries in a way that avoids the package name conflicts in
 * the Aspose libraries.
 *
...
object AsposeBridge {
  ...
  object Cells {
    ...
    def createWorkbook(
      ...
      options: com.aspose.cells.LoadOptions
  ...
  object Words {
    ...
    def createDocument(
      stream: java.io.InputStream,
      options: com.aspose.words.LoadOptions
  ...
  object Pdf {
    ...
    def createJpegDevice(resolution: com.aspose.pdf.devices.Resolution)
      : com.aspose.pdf.devices.JpegDevice =
      new com.aspose.pdf.devices.JpegDevice(resolution)

    def createJpegDevice(
