...
/**
 * Compatibility layer for Aspose classes to handle specific issues with Aspose library usage.
 * In Scala 3, we use this to avoid name conflicts with the com.aspose packages.
 */
