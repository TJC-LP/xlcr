...
trait LicenseAwareUdfWrapper {
  ...
  )(f: A => (R, Option[String], Option[Map[String, String]]))(implicit spark: SparkSession): UserDefinedFunction = {
  ...
  def licenseAwareUdf2[A: TypeTag, B: TypeTag, R: TypeTag](
      ...
      implementation: Option[String] = None,
      params: Option[Map[String, String]] = None
  )(f: (A, B) => (R, Option[String], Option[Map[String, String]]))(implicit spark: SparkSession): UserDefinedFunction = {
