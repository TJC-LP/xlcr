...
object CsvSplitterBenchmark {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val rowTemplate = "value1,value2,value3,value4,value5,value6,value7,value8,value9,value10"
  ...
  def benchmarkWithSize(rowCount: Int, header: String, rowTemplate: String): Unit = {
    ...
    val content = FileContent(csvBytes, MimeType.TextCsv).asInstanceOf[FileContent[MimeType.TextCsv.type]]
