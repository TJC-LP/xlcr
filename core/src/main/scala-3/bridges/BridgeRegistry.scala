...
object BridgeRegistry {
  ...
  def init(): Unit = {
    ...
    // Register them all with CORE priority:
    register(ApplicationVndOpenXmlFormatsSpreadsheetmlSheet, ApplicationJson, Priority.CORE, excelToJson)
    register(ApplicationJson, ApplicationVndOpenXmlFormatsSpreadsheetmlSheet, Priority.CORE, jsonToExcel)
    register(ApplicationVndOpenXmlFormatsSpreadsheetmlSheet, TextMarkdown, Priority.CORE, excelToMarkdown)
    register(TextMarkdown, ApplicationVndOpenXmlFormatsSpreadsheetmlSheet, Priority.CORE, markdownToExcel)
    register(ApplicationVndOpenXmlFormatsSpreadsheetmlSheet, ImageSvgXml, Priority.CORE, excelToSvg)
    register(ApplicationVndOpenXmlFormatsSpreadsheetmlSheet, ApplicationVndOasisOpendocumentSpreadsheet, Priority.CORE, ExcelToOdsBridge)
   ...
   */
  def registerCatchAllTo(outputMime: MimeType, priority: Priority, bridge: Bridge[_, _, _]): Unit = {
