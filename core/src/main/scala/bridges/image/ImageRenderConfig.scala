...
/** Generic config for any "binary → raster image" conversion.
  ...
  * @param maxHeightPx Maximum height in pixels for the rendered image
  * @param initialDpi Initial DPI for rendering (higher DPI = higher quality but larger images)
  * @param initialQuality Initial quality factor for JPEG rendering (0.0-1.0, higher is better quality but larger size)
  * @param autoTune Whether to automatically tune rendering parameters to meet size constraints
