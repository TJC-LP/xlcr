...
/** Converts any supported input to plain text using Tika.
  * 
  * This bridge can handle any input mime type and is registered
  * both for specific mime types and as a wildcard bridge to serve
  * as a fallback when no specific bridge is found.
  */
