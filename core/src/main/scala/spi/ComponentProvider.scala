...
/**
 * Information needed to register a Bridge. The type parameters ensure that the bridge's input and
 * output MIME types match the declared inMime and outMime fields, preserving type safety.
 *
 * @tparam I
 *   The input MimeType
 * @tparam O
