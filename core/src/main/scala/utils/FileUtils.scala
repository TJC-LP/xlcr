...
/**
 * Exception thrown when an unknown file extension is encountered.
 */
class UnknownExtensionException(path: Path, extension: String)
  extends IOException(s"Unknown file extension '$extension' for file: $path")
