...
object PathFilter {
  ...
  /** Determines if a path is a macOS metadata file or directory.
    ...
    * @return True if the path is a macOS metadata file or directory, false otherwise
    */
  ...
  /** Cleans a path for display by:
    ...
    * @return The cleaned path for display
    */
  ...
  /** Normalizes path separators to forward slashes.
    ...
    * @return The path with normalized separators
    */
  ...
  /** Filters out certain paths based on patterns.
    * 
    * @param paths The collection of paths to filter
    * @param includeMacOsFilter Whether to include the macOS metadata filter
    * @param additionalFilters Optional additional regex patterns to filter out
