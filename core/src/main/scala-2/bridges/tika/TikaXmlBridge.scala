...
object TikaXmlBridge extends TikaBridge[ApplicationXml.type] {
  override implicit val mTag: ClassTag[TikaModel[ApplicationXml.type]] =
    implicitly[ClassTag[TikaModel[ApplicationXml.type]]]
  override implicit val iTag: ClassTag[MimeType] =
    implicitly[ClassTag[MimeType]]
  override implicit val oTag: ClassTag[ApplicationXml.type] =
    implicitly[ClassTag[ApplicationXml.type]]
