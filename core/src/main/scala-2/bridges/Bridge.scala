 ...
 */
trait Bridge[M <: Model, I <: MimeType, O <: MimeType] extends BaseBridge[M, I, O] {
   ...
   */
  def chain[O2 <: MimeType](that: Bridge[M, _, O2])(implicit o2Tag: ClassTag[O2]): Bridge[M, I, O2] = {
    new Bridge[M, I, O2] {
      implicit val mTag: ClassTag[M] = Bridge.this.mTag
      implicit val iTag: ClassTag[I] = Bridge.this.iTag
      implicit val oTag: ClassTag[O2] = o2Tag
